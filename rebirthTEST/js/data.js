const qnaList = [
  {
    ...
    a: [
      { answer: "인싸라서 좀 많을 것 같아요." },
      { answer: "솔직히 많지는 않을 것 같아요." },
      { answer: "최소 50명?" },
  ...
  },
  {
    q: "6. 죽음은 어떤 느낌일까요?",
    a: [
      { answer: "너무 슬프고 아쉬울 것 같아요." },
      { answer: "의외로 홀가분할지도?" },
      { answer: "아직 안 죽어봐서 모르겠어요." },
      { answer: "아무 느낌 안 들 것 같아요." },
    ],
  },
  {
    q: "7. 죽기 전 나와 사이가 나쁜 사람을 만났어요.",
    a: [
      { answer: "모든 걸 다 용서하고 갈래요." },
      { answer: "나중에 자책할테니 화해해요." },
      { answer: "너 잘 만났다. 담판을 지어줘요." },
      { answer: "죽기 전에 뭐해요, 무시할래요." },
    ],
  },
  {
    q: "8. 이번 생에서 당신은 어떤 사람이었나요?",
    a: [
      { answer: "모자라지만 착한 친구." },
      { answer: "안 모자라고 착한 친구." },
      { answer: "모자라지만 나쁜 친구" },
